...
import { ListConversations } from './xListConversations';
    ...
    return (
      <div style={styles.conversations}>
        <ul style={styles.conversationList}>
              ...
              <button
                ...
                onClick={async () => {
                  ...
                  try {
                    ...
                    const newConversation = await client.conversations.newConversation(randomClient.address);
                    setSelectedConversation(newConversation);
                    setSearchTerm('');
                    if (newConversation?.peerAddress) {
                      router.push(`/dm/${newConversation?.peerAddress}`);
                    }
                  } catch (error) {
          ...
          />
          {message && conversationFound !== true && <small style={styles.messageClass}>{message}</small>}
