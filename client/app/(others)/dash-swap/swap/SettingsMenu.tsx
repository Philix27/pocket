...
import GearWhite from 'swap/gear_new.svg';
import GearBlack from 'swap/gear_new_white.svg';
import { DropdownModal } from './Dropdown';
import { setShowSlippage, setShowChart } from './swapSlice';
      ...
      buttonContent={(open) => (
        ...
        >
          <Image
            ...
            height={18}
          />
          <Image src={GearBlack} className={`${open ? 'hidden' : ''} dark:hidden m-0`} alt="" width={18} height={18} />
        </span>
      )}
