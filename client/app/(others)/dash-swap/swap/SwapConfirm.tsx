...
export function SwapConfirmCard({ formValues }: Props) {
  ...
  const { amountWei, quote, quoteWei, rate, refetch } = useSwapQuote(amount, direction, fromTokenId, toTokenId);
  ...
  return (
    ...
    >
      <div className="flex justify-between p-6  border-b border-primary-dark dark:border-[#333336]">
        ...
        <h2 className="text-[32px] dark:text-white leading-[40px] font-fg font-medium">Confirm Swap</h2>
        <button
      ...
      <div className="flex flex-col mx-6 items-center rounded-xl text-sm mt-6 border border-[#E5E7E9] dark:border-[#303033] dark:bg-[#18181B] ">
        <div className="flex items-center justify-between w-full py-4 mx-6">
          <div className="w-32 text-right text-[#636768] dark:text-[#AAB3B6] mr-6">Max Slippage:</div>
      ...
      <Modal isOpen={isModalOpen} title="Performing Swap" close={() => setIsModalOpen(false)} width="max-w-[432px]">
        <MentoLogoLoader />
      </Modal>
    </FloatingBox>
  );
...
const ChevronRight = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={20} height={20} fill="none" {...props}>
    <path stroke="currentColor" strokeLinecap="square" strokeWidth={1.33} d="m8.5 5.5 4 4.5-4 4.5" />
  </svg>
);
...
const BackArrow = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={7} height={12} fill="none" {...props}>
    <path stroke="currentColor" strokeLinecap="square" strokeWidth={1.33} d="M5.5 10.5 1.5 6l4-4.5" />
  </svg>
);
...
const RefreshSpinner = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={20} height={20} fill="none" {...props}>
    ...
    />
    <path stroke="currentColor" strokeLinecap="square" strokeWidth={1.33} d="M6.7 12.667H3.768a.4.4 0 0 0-.4.4V16" />
  </svg>
);
