...
import { useMemo, useEffect, ReactNode, SVGProps } from 'react';
import { Form } from 'react-hook-form';
import { toast } from 'sonner';
import { useAccount } from 'wagmi';
import { SettingsMenu } from './SettingsMenu';
import { setFormValues } from './swapSlice';
import { SwapFormValues, SwapDirection } from './types';
  ...
  return (
    ...
    >
      <div className="flex justify-between border-b border-primary-dark dark:border-[#333336] p-6">
        <h2 className="text-[32px] leading-10 font-fg font-medium text-primary-dark dark:text-white">Swap</h2>
        <SettingsMenu />
      </div>
      <div className="p-6">
        <SwapForm />
...
function SubmitButton() {
  ...
  const error = touched.amount && (errors.amount || errors.fromTokenId || errors.toTokenId || errors.slippage);
  let text;
  ...
  return (
    <div className="flex flex-col w-full items-center justify-center">
      {showLongError ? <div className="bg-[#E14F4F] rounded-md text-white p-4 mb-6">{error}</div> : null}
