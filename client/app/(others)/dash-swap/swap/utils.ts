...
export function getMinBuyAmount(amountInWei: BigNumber.Value, slippage: BigNumber.Value): BigNumber {
...
export function getMaxSellAmount(amountInWei: BigNumber.Value, slippage: BigNumber.Value): BigNumber {
