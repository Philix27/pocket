...
export function toWei(value: NumberT | null | undefined, decimals = STANDARD_TOKEN_DECIMALS): BigNumber {
...
export function parseAmountWithDefault(value: NumberT | null | undefined, defaultValue: NumberT): BigNumber {
...
export function getAdjustedAmount(_amountInWei: BigNumber.Value, _maxAmount: BigNumber.Value): BigNumber {
...
export const toSignificant = (
  ...
  const quotient = new Decimal(amount).div(JSBI.BigInt(1).toString()).toSignificantDigits(significantDigits);
