...
export const Valora = ({ chains = [Alfajores, Baklava, Celo], projectId }: WalletOptions): Wallet => ({
  id: 'valora',
  name: 'Valora',
  iconUrl:
...
export const CeloTerminal = ({ chains = [Alfajores, Baklava, Celo], projectId }: WalletOptions): Wallet => ({
  id: 'celo-terminal',
  name: 'Celo Terminal',
...
export const CeloWallet = ({ chains = [Alfajores, Baklava, Celo], projectId }: WalletOptions): Wallet => ({
  id: 'celo-wallet',
  name: 'Celo Wallet',
